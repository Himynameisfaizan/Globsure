    ...
    <div className="flex flex-col gap-5" style={{margin:'40px 0'}}>
      {faq.map((data) => {
        ...
        return (
          <div
            key={data.id}
            className="bg-[#0073bd20] border border-[#00224925] w-full rounded-lg flex flex-col gap-4" 
            style={{ padding: "15px" }}  >
            ...
            >
              <h2 className="text-[#002249] text-lg font-medium">{data.id}.   {data.question}</h2>
            ...
            >
              ...
              <i className="text-[#0073bd] ri-arrow-right-long-line"></i>  <p className="text-[#000000a6] text-base pt-2">
                  {data.answer}
                </p>
              </div>
            </div>
